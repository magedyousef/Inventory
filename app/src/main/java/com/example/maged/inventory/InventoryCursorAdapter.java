...
import static com.example.maged.inventory.data.InventoryContract.InventoryEntry;
...
public class InventoryCursorAdapter extends CursorAdapter {
    ...
    public void bindView(View view, final Context context, Cursor cursor) {
        ...
        String productQuantity = "INVENTORY \n" + String.valueOf(quantity) ;
        String productSold = "EXPIRED \n" + String.valueOf(products_sold) ;
